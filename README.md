# [roq-bitmex](https://roq-trading.com/docs/reference/gateways/crypto/roq-bitmex/)

Roq's BitMEX gateway.
...
Reference documentation can be found [here](https://roq-trading.com/docs/reference/gateways/crypto/roq-bitmex/).
