...
void WebSocket::operator()(Trace<json::Welcome> const &event) {
  profile_.welcome([&]() {
...
void WebSocket::operator()(Trace<json::Instrument> const &) {
  log::fatal("Unexpected"sv);
}

void WebSocket::operator()(Trace<json::Quote> const &) {
  log::fatal("Unexpected"sv);
}

void WebSocket::operator()(Trace<json::OrderBookL2> const &) {
  log::fatal("Unexpected"sv);
}
...
void WebSocket::operator()(Trace<json::Funding> const &) {
  log::fatal("Unexpected"sv);
}

void WebSocket::operator()(Trace<json::Liquidation> const &) {
  log::fatal("Unexpected"sv);
}

void WebSocket::operator()(Trace<json::Settlement> const &) {
  log::fatal("Unexpected"sv);
}

void WebSocket::operator()(Trace<json::Margin> const &event) {
  profile_.margin([&]() {
...
void WebSocket::operator()(Trace<json::Position> const &event) {
  profile_.position([&]() {
...
void WebSocket::operator()(Trace<json::Order> const &event) {
  profile_.order([&]() {
...
void WebSocket::operator()(Trace<json::Execution> const &event) {
  profile_.execution([&]() {
